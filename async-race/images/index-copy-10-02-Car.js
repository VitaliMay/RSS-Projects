export const svgStartInner = `
 <svg fill="#ff0000" width="0px" height="0px" transform="matrix(-1, 0, 0, 1, 0, 0)" xmlns="http://www.w3.org/2000/svg">
      <symbol id="carSymbol-01" viewBox="0 -43.92 122.88 122.88" version="1.1" xmlns="http://www.w3.org/2000/svg"
      ...
      <use xlink:href="#carSymbol-01" />
    </svg>
`

let colorCar = 'red'

export const svgImgInner = `
<svg fill=${colorCar} class="svgImgCar" width="60px" height="60px" transform="matrix(-1, 0, 0, 1, 0, 0)"
